 ...
 */
final class Version20211222162852 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE allocation (id INT NOT NULL, koopman_id INT NOT NULL, branche_id INT NOT NULL, markt_id INT NOT NULL, is_allocated BOOLEAN NOT NULL, reject_reason VARCHAR(255) DEFAULT NULL, plaatsen TEXT DEFAULT NULL, date DATE NOT NULL, anywhere BOOLEAN NOT NULL, minimum INT NOT NULL, maximum INT NOT NULL, is_bak BOOLEAN NOT NULL, has_inrichting BOOLEAN NOT NULL, PRIMARY KEY(id))');
