...
use App\Azure\Config\SASFileReaderConfig;
use App\Azure\Config\SASFileWriterConfig;
...
class AzureStorage implements AzureStorageInterface
{
     ...
     *                This file van only be downloaded, not shown
     *
    ...
    public function deleteFile(?string $file): bool
    {
        ...
        if (202 != $apiResponse->getStatusCode()) {
            return false;
        }
