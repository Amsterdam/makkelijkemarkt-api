...
class TariefplanControllerTest extends ApiTestCase
{
    ...
    public function testPostLineairplan(): int
    {
        ...
        $data = [
            ...
            'geldigTot' => ['date' => $dt->format('Y').'-12-31 23:59:59'],
            'tariefPerMeter' => 1.00,
            'tariefPerMeterKlein' => 1.00,
            'tariefPerMeterGroot' => 3.00,
            'reinigingPerMeter' => 1.01,
            'reinigingPerMeterKlein' => 1.01,
            'reinigingPerMeterGroot' => 2.01,
    ...
    public function testPutLineairplan(int $id): void
    {
        ...
        $data = [
            ...
            'tariefPerMeterKlein' => 11.00,
            'tariefPerMeterGroot' => 13.00,
            'reinigingPerMeter' => 11.01,
            'reinigingPerMeterKlein' => 11.01,
            'reinigingPerMeterGroot' => 12.01,
